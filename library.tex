...
\addto\captionsenglish{
    \renewcommand{\contentsname}{Mục lục} % Đổi "Mục lục" thành "Table of Contents"
    \renewcommand{\chaptername}{Chương} % Đổi "Chương" thành "Chapter"
    \renewcommand{\bibname}{Tài liệu tham khảo} % Đổi "Tài liệu tham khảo" thành "References"
    \renewcommand{\appendixname}{Phụ lục} % Đổi "Phụ lục" thành "Appendix"
}
% Chèn code
