...
\[
    N_{max} = \dfrac{60v_L}{p} = \dfrac{60 \times 0.12}{\dfrac{5}{1000}} = 1440 \text{ rpm}
\]
...
\begin{itemize}
    ...
    \[
        J_{vitme} = \dfrac{\pi}{32}\rho.L.d^4 = \dfrac{\pi}{32} \times 7850 \times 0.4 \times 0.02^4 = 4.9 \times 10^{-5} (kg.m^2)
    \]
    
    \item Momen quán tính bàn trượt (di chuyển tuyến tính):
    \[
        J_{ban\_truot} = m.\left(\dfrac{p}{2\pi}\right)^2 = 12.\left(\dfrac{\dfrac{5}{1000}}{2\pi}\right)^2 = 7.6 \times 10^{-6} (kg.m^2)
    \]
...
\hspace*{0.6cm}Công thức tính momen tải trục vitme (bỏ qua preload):
    \[
        T_L = \dfrac{P}{2\pi} \cdot \dfrac{F}{\eta}
    \]
\hspace*{0.6cm}Công thức tính giá trị lực tác dụng:
    \[
        F = F_A + \mu mg = F_A + 0.4701 \text{ (N)}
    \]
\hspace*{0.6cm}Lần lượt tính các giá trị trên cho từng giai đoạn chuyển động:
\begin{itemize}
    ...
    \]
    \[
        \Rightarrow T_L = \dfrac{5/1000}{2\pi} \cdot \dfrac{0.4701}{0.9} = 4.16 \times 10^{-4} \text{ Nm}
    \]
    ...
    \]
    \[
        \Rightarrow T_L = \dfrac{5/1000}{2\pi} \cdot \dfrac{200.4701}{0.9} = 0.1773 \text{ Nm}
    \]
\end{itemize}
...
\begin{itemize}
    ...
    \[
        T_a = \dfrac{(J_L + J_0)N_{max}}{9.55t} = \dfrac{(6.16 \times 10^{-5} + J_0)N_{max}}{9.55t}
    \]
...
\hspace*{0.6cm}Thời gian tăng tốc:
\[
    t_{a1} = \dfrac{v_1 - 0}{a} = \dfrac{0.1 - 0}{2} = 0.05s
\]

Đoạn đường tăng tốc:
\[
    L_{a1} = \dfrac{v_1^2 - 0^2}{2a} = \dfrac{0.1^2 - 0}{2 \times 2} = 0.0025m
\]
\hspace*{0.6cm}Thời gian giảm tốc:
\[
    t_{d1} = \dfrac{v_1 - v_2}{a} = \dfrac{0.1 - 0.02}{2} = 0.04s
\]
\hspace*{0.6cm}Đoạn đường giảm tốc:
\[
    L_{d1} = \dfrac{v_2^2 - v_1^2}{2a} = \dfrac{0.02^2 - 0.1^2}{2 \times 2} = 0.0024m
\]
...
\[
    t_{v1} = \dfrac{L_{v1}}{v_1} = \dfrac{0.1451}{0.1} = 1.451 \text{ s}
\]
\subsection{Cutting feed}
\hspace*{0.6cm}Thời gian giảm tốc:
\[
    t_{d2} = \dfrac{v_2 - v_1}{a} = \dfrac{0.02 - 0}{2} = 0.01s
\]
\hspace*{0.6cm}Đoạn đường giảm tốc:
\[
    L_{d2} = \dfrac{v_1^2 - v_2^2}{2a} = \dfrac{0^2 - 0.02^2}{2 \times 2} = 0.0001m
\]
\hspace*{0.6cm}Đoạn đường chuyển động đều:
\[
    L_{v2} = L_2 - L_{d2} = 0.1 - 0.0001 = 0.0999 \text{ m}
\]
\hspace*{0.6cm}Thời gian chuyển động đều:
\[
    t_{v2} = \dfrac{L_{v2}}{v_2} = \dfrac{0.0999}{0.02} = 4.995 \text{ s}
\]
\subsection{Quick return}
\hspace*{0.6cm}Thời gian tăng tốc:
\[
    t_{a3} = \dfrac{v_3 - v_2}{a} = \dfrac{0.12 - 0.02}{2} = 0.05s
\]

Đoạn đường tăng tốc:
\[
    L_{a3} = \dfrac{v_3^2 - v_2^2}{2a} = \dfrac{0.12^2 - 0.02^2}{2 \times 2} = 0.0035m
\]

Đoạn đường giảm tốc:
\[
    L_{d3} = \dfrac{v_3^2 - 0^2}{2a} = \dfrac{0.12^2 - 0^2}{2 \times 2} = 0.0036m
\]
...
Thời gian chuyển động đều:
\[
    t_{v3} = \dfrac{L_{v3}}{v_3} = \dfrac{0.2429}{0.12} = 2.02417 \text{ s}
\]

Thời gian giảm tốc:
\[
    t_{d3} = \dfrac{v_3 - 0}{a} = \dfrac{0.12 - 0}{2} = 0.06s
\]
...
\hspace*{0.6cm}Chọn trước động cơ ECMA-C10602ES của hãng Delta
\begin{figure}[H]
    \centering
...
\]
\[
    \Rightarrow \text{Tỷ lệ momen quán tính: } \dfrac{J_L}{J_M} = \dfrac{6.16 \times 10^{-5}}{0.192 \times 10^{-4}} = 3.208
\]

Với $T_a$ được tính như sau:
\[
    T_a = \dfrac{(J_L + J_0)N_{max}}{9.55t} = \dfrac{(6.16 \times 10^{-5} + J_0)N_{max}}{9.55t} = \dfrac{(6.16 \times 10^{-5} + J_0)\Delta N_{max}}{9.55\Delta t}
\]
...
\[
    T_a = \dfrac{(6.16 \times 10^{-5} + 0.192 \times 10^{-4}) \times 1440}{9.55 \times 0.05} = 0.24367 Nm
\]
\[
    \Rightarrow T_{max2} = T_L + T_a = 4.16 \times 10^{-4} + 0.24367 = 0.244086 \text{ Nm}
\]
\hspace*{0.6cm}Momen tải đỉnh là:
\[
    \Rightarrow T_M = T_{max2} = 0.244086 \text{ Nm}
\]
\section{Tính momen RMS}
\hspace*{0.6cm}Momen RMS được tính theo công thức với các giá trị đã có trên bảng tổng hợp thời gian và quãng đường các giai đoạn:
\[
    T_{RMS} = \sqrt{\dfrac{(T_{a1} + T_{L1})^2t_{a1} + T_{L1}^2 \cdot t_{v1} + (T_{d1} - T_{L1})^2t_{d1} + T_{L2}^2 \cdot t_{v2} + (T_{a3} + T_{L3})^2t_{a3} + T_{L3}^2 \cdot t_{v3} + (T_{d3} - T_{L3})^2t_{d3}}{t_{total}}}
\]
\[
    = \sqrt{\dfrac{(0 + 4.16 \times 10^{-4})^2 \cdot 0.05 + (4.16 \times 10^{-4})^2 \cdot 1.451 + (0 - 4.16 \times 10^{-4})^2 \cdot 0.04 + (0.1773)^2 \cdot 4.995 + (0 + 4.16 \times 10^{-4})^2 \cdot 0.05 + (4.16 \times 10^{-4})^2 \cdot 2.02417 + (0 - 4.16 \times 10^{-4})^2 \cdot 0.06}{8.68017}}
\]
\[
    = 0.1197 \text{ Nm}
\]
